...
class ProlinkNetwork {
     ...
     */
    async autoconfigFromPeers(enableCDJ3000Compatibility) {
        ...
        __classPrivateFieldSet(this, _ProlinkNetwork_config, {
            ...__classPrivateFieldGet(this, _ProlinkNetwork_config, "f"),
            vcdjId: constants_1.DEFAULT_VCDJ_ID,
            iface,
    ...
    connect() {
        ...
        const vcdj = (0, virtualcdj_1.getVirtualCDJ)(__classPrivateFieldGet(this, _ProlinkNetwork_config, "f").iface, __classPrivateFieldGet(this, _ProlinkNetwork_config, "f").vcdjId, __classPrivateFieldGet(this, _ProlinkNetwork_config, "f").enableCDJ3000Compatibility);
        // Start announcing
 ...
 */
const getVirtualCDJ = (iface, id, enableCDJ3000Compatibility) => ({
    id,
